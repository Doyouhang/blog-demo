...
export const interests: Interest[] = [
  {
    emoji: '📷', slug: 'photography', title: '摄影', featured: true,
    desc: '喜欢扫街和风光，器材是富士 X 系列。',
    tags: ['街头', '风光', '胶片模拟'],
  },
  {
    emoji: '📚', slug: 'reading', title: '读书', featured: true,
    desc: '偏社科、历史和科幻，今年目标是 24 本。',
    tags: ['非虚构', '科幻'],
  },
  {
    emoji: '🧭', slug: 'travel', title: '旅行', featured: true,
    desc: '走过川西、云南和东南亚，最爱小城慢生活。',
    tags: ['国内', '东南亚'],
  },
  {
    emoji: '💻', slug: 'coding', title: '代码', featured: true,
    desc: '业余写点小工具，最近在玩 Astro 和自动化。',
    tags: ['前端', '自动化'],
  },
  {
    emoji: '🍳', slug: 'cooking', title: '下厨',
    desc: '周末喜欢研究面食和家常菜。',
    tags: ['面食', '家常'],
  },
  {
    emoji: '🎧', slug: 'music', title: '音乐',
    desc: '从后摇到 city pop，写代码时循环播放。',
    tags: ['后摇', 'City Pop'],
  },
  {
    emoji: '📈', slug: 'stocks', title: '股票',
